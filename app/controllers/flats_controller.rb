class FlatsController < ApplicationController
  ...
  def index
    ...
    @markers = @flats.geocoded.near('Tokyo', 20).map do |flat|
      {
        lat: flat.latitude,
        lng: flat.longitude,
        popup_html: render_to_string(partial: "map_popup", locals: {flat: flat}),
        marker_html: render_to_string(partial: "map_marker", locals: {flat: flat}),
      }
    end
  end
